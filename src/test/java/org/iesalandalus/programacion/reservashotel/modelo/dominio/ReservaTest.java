...
public class ReservaTest {
    ...
    private static final String OBJETO_DEBERIA_SER_NULO = "No se deber�a haber creado el objeto reserva.";
    private static final String MENSAJE_EXCEPCION_NO_CORRECTO = "El mensaje devuelto por la excepci�n no es correcto.";
    private static final String ERROR_HUESPED_NULO="ERROR: El hu�sped de una reserva no puede ser nulo.";
    private static final String ERROR_HABITACION_NULA="ERROR: La habitaci�n de una reserva no puede ser nula.";
    private static final String ERROR_REGIMEN_NULO="ERROR: El r�gimen de una reserva no puede ser nulo.";
    ...
    private static final String RESERVA_NULA = "Deber�a haber saltado una excepci�n indicando que no se puede copiar una reserva nula.";
    ...
    private static final String ERROR_EXCEPCION_FECHA_INICIO_RESERVA="Deber�a haber saltado una excepci�n indicando que no se puede establecer una fecha de inicio de reserva nula.";
    private static final String ERROR_EXCEPCION_FECHA_FIN_RESERVA="Deber�a haber saltado una excepci�n indicando que no se puede establecer una fecha de fin de reserva nula.";
    private static final String ERROR_FECHA_INICIO_RESERVA_ANTERIOR="ERROR: La fecha de inicio de la reserva no puede ser anterior al d�a de hoy.";
    ...
    private static final String ERROR_EXCEPCION_FECHA_INICIO="Deber�a haber saltado una excepci�n indicando que la fecha de inicio no es correcta.";
    private static final String ERROR_EXCEPCION_FECHA_FIN="Deber�a haber saltado una excepci�n indicando que la fecha de fin no es correcta.";
    ...
    private static final String ERROR_EXCEPCION_CHECKIN_NULO="Deber�a haber saltado una excepci�n indicando que no se puede establecer una fecha de checkin nula.";
    private static final String ERROR_EXCEPCION_CHECKIN="Deber�a haber saltado una excepci�n indicando que el checkin no es v�lido.";
    ...
    private static final String ERROR_EXCEPCION_CHECKOUT_NULO="Deber�a haber saltado una excepci�n indicando que no se puede establecer una fecha de checkout nula.";
    private static final String ERROR_CHECKOUT_NULO="ERROR: El checkout de una reserva no puede ser nulo.";
    private static final String ERROR_EXCEPCION_CHECKOUT="Deber�a haber saltado una excepci�n indicando que el checkout no es v�lido.";
    private static final String ERROR_CHECKOUT_ANTERIOR="ERROR: El checkout de una reserva no puede ser anterior al checkin.";
    private static final String ERROR_CHECKOUT_POSTERIOR="ERROR: El checkout de una reserva puede ser como m�ximo 12 horas despu�s de la fecha de fin de la reserva.";
    private static final String MENSAJE_PRECIO_NO_CORRECTO="El precio calculado no es correcto.";
    private static final String ERROR_NUMERO_PERSONAS_RESERVA="ERROR: El n�mero de personas de una reserva no puede ser menor o igual a 0.";
    private static final String ERROR_NUMERO_MAXIMO_PERSONAS_RESERVA="ERROR: El n�mero de personas de una reserva no puede superar al m�ximo de personas establacidas para el tipo de habitaci�n reservada.";
    ...
    void toStringDevuelveLaCadenaEsperada() {
        ...
        String cadenaEsperada=String.format("Huesped: %s %s Habitaci�n:%s - %s Fecha Inicio Reserva: %s Fecha Fin Reserva: %s Checkin: %s Checkout: %s Precio: %.2f Personas: %d", reserva.getHuesped().getNombre(), reserva.getHuesped().getDni(),
        ...
        cadenaEsperada=String.format("Huesped: %s %s Habitaci�n:%s - %s Fecha Inicio Reserva: %s Fecha Fin Reserva: %s Checkin: %s Checkout: %s Precio: %.2f Personas: %d", reserva.getHuesped().getNombre(), reserva.getHuesped().getDni(),
                reserva.getHabitacion().getIdentificador(),reserva.getHabitacion().getTipoHabitacion(), reserva.getFechaInicioReserva().format(formatoFecha),
