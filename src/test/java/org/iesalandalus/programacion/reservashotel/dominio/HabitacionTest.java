...
public class HabitacionTest {
    ...
    private static final String PUERTA_NO_ESPERADA = "El n�mero de puerta devuelta no es la misma que la pasada al constructor.";
    private static final String PRECIO_HABITACION_NO_ESPERADO = "El precio devuelto no es el mismo que el pasada al constructor.";
    private static final String TIPO_HABITACION_NO_ESPERADA = "El tipo de habitaci�n devuelta no es el mismo que el pasada al constructor.";
    private static final String IDENTIFICADOR_HABITACION_NO_ESPERADO = "El identificador de la habitaci�n no es el esperado.";
    ...
    private static final String OBJETO_DEBERIA_SER_NULO = "No se deber�a haber creado el objeto habitaci�n.";
    private static final String TIPO_EXCEPCION_NO_CORRECTA = "El tipo de la excepci�n no es correcto.";

    private static final String PLANTA_INCORRECTA = "Deber�a haber saltado una excepci�n indicando que la planta es incorrecta.";
    private static final String ERROR_PLANTA_INCORRECTA= "ERROR: No se puede establecer como planta de una habitaci�n un valor menor que " + Habitacion.MIN_NUMERO_PLANTA + " ni mayor que " + Habitacion.MAX_NUMERO_PLANTA + ".";
    private static final String PUERTA_INCORRECTA="Deber�a haber saltado una excepci�n indicando que la puerta es incorrecta.";
    private static final String ERROR_PUERTA_INCORRECTA= "ERROR: No se puede establecer como puerta de una habitaci�n un valor menor que " + Habitacion.MIN_NUMERO_PUERTA + " ni mayor que " + Habitacion.MAX_NUMERO_PUERTA + ".";

    private static final String PRECIO_HABITACION_INCORRECTO= "Deber�a haber saltado una excepci�n indicando que el precio de la habitaci�n es incorrecto.";
    private static final String ERROR_PRECIO_HABITACION_INCORRECTO= "ERROR: No se puede establecer como precio de una habitaci�n un valor menor que " + Habitacion.MIN_PRECIO_HABITACION + " ni mayor que " + Habitacion.MAX_PRECIO_HABITACION + ".";

    private static final String TIPO_HABITACION_INCORRECTO = "Deber�a haber saltado una excepci�n indicando que el tipo de la habitaci�n es incorrecto.";
    private static final String ERROR_TIPO_HABITACION_NULA="ERROR: No se puede establecer un tipo de habitaci�n nula.";

    private static final String HABITACION_NO_ESPERADA = "La habitaci�n copiada deber�a ser la misma que la pasada como par�metro.";

    private static final String HABITACION_NULA = "Deber�a haber saltado una excepci�n indicando que no se puede copiar una habitaci�n nula.";
    private static final String ERROR_COPIAR_HABITACION_NULA = "ERROR: No es posible copiar una habitaci�n nula.";
